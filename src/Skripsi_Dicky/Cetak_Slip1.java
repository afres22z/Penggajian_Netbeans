 ...
 * @author Software
 */
public class Cetak_Slip1 extends javax.swing.JFrame {
 ...
 new Menu_Manager().show();   this.dispose();        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cetak_Slip1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Cetak_Slip1().setVisible(true);
            }
        });
    }
