 ...
 * @author Software
 */
public class master_data_cuti extends javax.swing.JFrame {
...
Connection conn = new koneksidb.koneksi().getConnection();
    ...
    private String[] label={"NO","NIP","NAMA","JENIS","Dari","SAMPAI","KETERANGAN"};
    
    public master_data_cuti() {
        initComponents();      
        bacatabel();
        autonumber();  
        tampilNIP ();
   ...
   void autonumber(){
        ...
        s  = conn.createStatement();
         String sql = "select max(No) from izin";
      ...
      private  void bacatabel(){
       try {
           ...
           while(r.next()){
                ...
                data_golongan[x][3]=r.getString("jenis");
                data_golongan[x][4]=r.getString("dari");
                data_golongan[x][5]=r.getString("sampai");
      ...
      private void tampilNIP (){
       ...
       txtAbsen_tanggal1.getDate()==null||
       radAbsen_cuti.getText().equals("")||
       radAbsen_izin.getText().equals(""))
      {
   ...
   String absen_tanggal2 = "";
        ...
        if(txtAbsen_tanggal1.getDate() != null){
        SimpleDateFormat Format = new SimpleDateFormat("yyyy-MM-dd");
        absen_tanggal2 = Format.format(txtAbsen_tanggal1.getDate());
        }
        String absen_izin = "";
        
        if(buttonGroup1.getSelection().equals(radAbsen_cuti.getModel())){
            absen_izin = "Cuti";
        }
        else if(buttonGroup1.getSelection().equals(radAbsen_izin.getModel())){
            absen_izin = "Izin";
        }else{
            JOptionPane.showMessageDialog(rootPane, "Harap isi semua field");  
        }   
       try {
           String sql="insert into izin values('"+jTextField1.getText()+"','"+jTextField2.getSelectedItem()+"','"+jTextField3.getText()+"','"+absen_izin+"','"+absen_tanggal1+"','"+absen_tanggal2+"','"+jTextArea1.getText()+"')";
           s.executeUpdate(sql);
           s.close();
   ...
   String absen_tanggal2 = "";
       ...
       try {
           String sql="update izin set nip='"+jTextField2.getSelectedItem()+"',nama='"+jTextField3.getText()+"',jenis='"+absen_izin+"',dari='"+absen_tanggal1+"',sampai='"+absen_tanggal2+"',Ket='"+jTextArea1.getText()+"' where No='"+jTextField1.getText()+"'";
           s.executeUpdate(sql);
           s.close();
           ...
           JOptionPane.showMessageDialog(null,e);
                 ...
                 private void hapus() {
       try {
           String sql="delete from izin where No='"+jTextField1.getText()+"'";
           s.executeUpdate(sql);
           s.close();
       ...
       txtAbsen_tanggal1.setDate(null);
       ...
       String cuti_izin = (String) jTable1.getValueAt(i, 3);
       ...
       SimpleDateFormat date = new SimpleDateFormat("yyyy-MM-dd");
        ...
        try {
            dateValue = date.parse((String) jTable1.getValueAt(i, 4));
            txtAbsen_tanggal.setDate(dateValue);
            dateValue2 = date.parse((String) jTable1.getValueAt(i, 5));
            txtAbsen_tanggal1.setDate(dateValue2);
        } catch (ParseException ex) {
            Logger.getLogger(master_data_cuti.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        txtAbsen_tanggal1 = new com.toedter.calendar.JDateChooser();
        ...
        jLabel5.setText("MASTER DATA IZIN / CUTI KARYAWAN");
        ...
        txtAbsen_tanggal1.setBackground(new java.awt.Color(249, 249, 249));
        txtAbsen_tanggal1.setToolTipText("");
        txtAbsen_tanggal1.setDateFormatString("yyyy-MM-d");
        ...
        buttonGroup1.add(radAbsen_izin);
        ...
        buttonGroup1.add(radAbsen_cuti);
                ...
                .addGroup(panelEfectLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panelEfectLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, panelEfectLayout.createSequentialGroup()
                            ...
                            .addGap(0, 0, 0)
                            .addComponent(txtAbsen_tanggal1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, panelEfectLayout.createSequentialGroup()
                ...
                .addGroup(panelEfectLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panelEfectLayout.createSequentialGroup()
                        ...
                        .addGroup(panelEfectLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtAbsen_tanggal1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(panelEfectLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(panelEfectLayout.createSequentialGroup()
...
if(jTextField1.getText().equals("")||
    ...
    try { 
            ...
            File file = new File("src/Laporan/lap_cuti.jrxml");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(master_data_cuti.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new master_data_cuti().setVisible(true);
            }
        });
    }
    ...
    private com.toedter.calendar.JDateChooser txtAbsen_tanggal1;
